      ...
      <div class="card-body">
        <form method="POST" action="{{ route('pasien.store') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="alamat_pasien" name="alamat_pasien" placeholder="Alamat Pasien" value="{{ old('alamat_pasien') }}">
          </div>
          <div class="form-group">
            <label for="no_telp">Nomor Telepon</label>
            <input type="tel" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" placeholder="Nomor Telpon Pasien" value="{{ old('no_telp') }}">
            @error('no_telp')
          ...
          <div class="form-group">
            ...
            <textarea class="form-control @error('keluhan_pasien') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" name="keluhan_pasien">{{ old('keluhan_pasien') }}</textarea>
