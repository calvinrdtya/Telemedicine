    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Formulir Perjanjian Pasien
          <span>
            <a href="{{ route('praktek.index') }}" class="btn ml-4 btn-primary font-weight-bold"><i class="fas fa-arrow-left"></i>
               back
            </a>
          </span>
        </h6>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('praktek.store') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_pasien" name="nama_pasien" placeholder="Nama Lengkap" value="{{ old('nama_pasien') }}">
            @error('nama_pasien')
          ...
          <div class="form-group">
            ...
            <select name="waktu_perjanjian" class="form-control" id="waktu_perjanjian">
              <option value="Pagi (09:00)">Pagi (09:00)</option>
              <option value="Pagi (10:00)">Pagi (10:00)</option>
          ...
          <button type="submit" class="btn btn-info">Buat janji</button>
        </form>
      </div>
    </div>
  </div>
