...
<body class="mx-auto">
  <header class="clearfix">
    ...
    <div id="company" class="clearfix">
      <div>Kartu Perjanjian</div>
      <div>Jln. SumberGedong, Trenggalek</div>
      <div>(+62) 83834573749</div>
  ...
  <main>
    ...
    <div id="notices">
      ...
      <div class="notice" style="margin-bottom: 20px">
        <strong>Harap Datang Sesuai Waktu Perjanjian</strong>
      </div>
    </div>
  </main>
  <footer>
