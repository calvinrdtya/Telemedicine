                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="card-header mb-0">Data Motor</h5>
                            <div class="d-flex align-items-center">
                                <a href="{{ route('mitra.motor.create') }}" class="btn btn-sm btn-primary me-3">
                                    Tambahkan Motor
                                </a>
                                ...
                                <tbody class="table-border-bottom-0">
                                    @forelse($motors as $index => $motor)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($motor->image)
                                                <img src="{{ asset('img/' . $motor->image) }}" alt="Motor Image" width="80">
                                                @else
                                                No Image Available
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('mitra.motor.detail', ['motorId' => $motor->id]) }}" type="button" class="btn btn-sm btn-outline-primary me-2">
                                                    ...
                                                    <form id="delete-form-{{ $motor->id }}" action="{{ route('mitra.motor.destroy', $motor->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
