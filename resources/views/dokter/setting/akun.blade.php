        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Mitra /</span> Akun</h4>
    
                  <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills flex-column flex-md-row mb-3">
                            <li class="nav-item">
                              {{-- <a class="nav-link" href="{{ route('mitra.transportasi.data') }}"><i class="bx bx-user me-1"></i>Data</a> --}}
                            </li>
                            <li class="nav-item">
                              <a class="nav-link {{ request()->routeIs('mitra.transportasi.akun') ? 'active' : '' }}" href="{{ route('mitra.transportasi.akun') }}"><i class="bx bx-receipt me-1"></i>Akun</a>
                            </li>
                            <li class="nav-item">
                          ...
                          <form id="formAccountSettings" method="POST" onsubmit="return false">
                            <div class="row">
                              ...
                              <div class="mb-3 col-md-6">
                                ...
                                <input readonly class="form-control" type="text" id="email" name="email" value="">
                              </div>
                              <div class="mb-3 col-md-6">
